	...
	include '../header.php';
  	include '../sidebar.php';
   	...
   	if (isset($_POST['submit'])) {
		...
		$satuan = strtoupper(mysqli_real_escape_string($conn,$_POST['satuan']));
		...
		$insert = "INSERT INTO tbl_brg(id_barang,nama_barang,satuan,harga_beli,harga_jual,stok,supplier) VALUES ('$kode','$nama','$satuan','$harga_beli','$harga_jual','$stok','$sup')";
	        ...
	        <div class="col-md-8">
              ...
              <div class="form-group col-md-7">
                	...
                	<div class="form-group col-md-7">
                  		...
                  		<div class="input-group">
                  			<span class="input-group-addon" id="basic-addon3">Rp.</span>
                  			<input type="text" class="form-control" id="harga_jual1" name="harga_jual" placeholder="Masukan Harga Jual Barang" required aria-describedby="basic-addon4">
                  		</div>
                	</div>
						<div class="form-group col-md-7">
