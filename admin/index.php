  ...
  <section class="content">
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-12">
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
              $sql2 = "SELECT COUNT(id_barang) AS jumlah FROM tbl_brg";
              // nilai 0 = delete no
            ...
            <a href="/tb/barang/list_barang.php" class="small-box-footer">
      ...
      <div class="col-lg-4 col-xs-12">
        <div class="small-box bg-yellow">
          <div class="inner">
            ...
            <h3><?php echo rupiah(total_harian($date,6,$path)) ?></h3>
      ...
      <div class="col-lg-4 col-xs-12">
        <div class="small-box bg-green">
          <div class="inner">
            ...
            // $rows2 = mysqli_fetch_assoc($run_sql2);
            ?>
            <h3><?php echo rupiah(total_tahunan($year,6,$path)) ?></h3>
    ...
    <div class="row">
      <div class="col-lg-6 col-xs-12">
        <?php 
         $sql_1 = "SELECT MONTH(tanggal) AS Bulan_ FROM tbl_transaksi WHERE YEAR(tanggal) = $year GROUP BY MONTH(tanggal) ASC";
          $run_sql_1 = mysqli_query($conn,$sql_1);
          
          $sql_2 = "SELECT SUM(grandtotal) AS Total_1 FROM tbl_transaksi WHERE YEAR(tanggal) = $year GROUP BY MONTH(tanggal) ASC";
      ...
      <div class="col-lg-6 col-xs-12">
        ...
        $sql_barang = "SELECT COUNT(tbl_detail_transaksi.id_barang) AS Barang, tbl_brg.nama_barang AS Nama FROM tbl_detail_transaksi JOIN tbl_brg USING(id_barang)  GROUP BY id_barang LIMIT 6";
       ...
       <!-- DONUT CHART -->
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Barang Paling Banyak Terjual</h3>
            </div>
            <div class="box-body">
    ...
    <div class="row">
      <div class="col-lg-6 col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                $sql = "SELECT * FROM tbl_transaksi WHERE DATE(tanggal) = CURDATE() ORDER BY tanggal DESC LIMIT 5";
        ...
        <div class="box-footer">
          <a href="/tb/laporan/laporan_tahun.php">More Info</a>
        </div>
      </div>
    </div>
    <div class="col-lg-6 col-xs-12">
            ...
            datasets: [
              {
                ...
                data                : [<?php $sql_1 = "SELECT MONTH(tanggal) AS Bulan_ FROM tbl_transaksi WHERE YEAR(tanggal) = $year GROUP BY MONTH(tanggal) ASC";$run_sql_1 = mysqli_query($conn,$sql_1);while($rows_1 = mysqli_fetch_assoc($run_sql_1)){if (++$counter == $numResults) {echo total_bulanan($year,$rows_1['Bulan_'],6,$path);} else {echo total_bulanan($year,$rows_1['Bulan_'],6,$path).',';}}?>]
              }]
          }
