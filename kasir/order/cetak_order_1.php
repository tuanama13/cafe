...
// include "../init/db.php";
    ...
    $pdf->Cell(30,2,$row['tgl_order'],0,1,'R');
    // $pdf->Ln(4);
    // $pdf->SetFont('Arial','',7);
    $pdf->Cell(60,2,'-----------------------------------------------------------------------',0,1,'L');
    ...
    foreach ($result as $value) {
        ...
        $pdf->Cell(15,3,norupiah((int)$value['harga_produk']),0,1,'R');
    ...
    $pdf->Cell(15,3,norupiah((int)$row['grandtotal']),0,1,'R');

    // $pdf->Cell(30,3,'Bayar',0,0,'L');
    // $pdf->Cell(15,3,'Rp',0,0,'R');
    // $pdf->Cell(15,3,norupiah((int)$bayar),0,1,'R');
    
    // $pdf->Cell(30,3,'Kembalian',0,0,'L');
    // $pdf->Cell(15,3,'Rp',0,0,'R');
    // $pdf->Cell(15,3,norupiah((int)$kembali),0,1,'R');
