  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=""><a href="/tb/index.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
...
<li class="treeview">
  <a href="#"><i class="fa fa-industry"></i> <span> Pembelian</span>
  <span class="pull-right-container">
    <i class="fa fa-angle-left pull-right"></i>
  </span>
</a>
...
<ul class="treeview-menu">
<li><a href="/tb/laporan/laporan_tahun.php" > <i class="fa fa-file-o"></i>Laporan Penjualan</a></li>

<!-- <li><a href="/tb/laporan/laporan_karyawan.php"><i class="fa fa-file-o"></i>Laporan Karyawan</a></li> -->
<li><a href="/tb/laporan/laporan_retur.php"><i class="fa fa-file-o   "></i>Laporan Retur</a></li>
<li><a href="/tb/laporan/laporan_pengeluaran.php"><i class="fa fa-file-o   "></i>Laporan Pengeluaran</a></li>
<li><a href="/tb/laporan/laporan_barang_kosong.php"><i class="fa fa-file-o   "></i>Laporan Barang Kosong</a></li>
</ul>
</li>
</ul>
<!-- /.sidebar-menu -->
